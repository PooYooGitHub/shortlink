...
public interface LinkAccessStatsMapper extends BaseMapper<LinkAccessStatsDO>
{
    ...
    @Insert("""
            INSERT INTO t_link_access_stats (
              ...
              #{linkAccessStatsDO.fullShortUrl},
              #{linkAccessStatsDO.gid},
              #{linkAccessStatsDO.date},
              #{linkAccessStatsDO.pv},
              #{linkAccessStatsDO.uv},
              #{linkAccessStatsDO.uip},
              #{linkAccessStatsDO.hour},
              #{linkAccessStatsDO.weekday},
              NOW(),
              NOW(),
              #{linkAccessStatsDO.delFlag}
            ) ON DUPLICATE KEY UPDATE
              pv = #{linkAccessStatsDO.pv} + pv,
              uv = #{linkAccessStatsDO.uv} + uv,
              uip = #{linkAccessStatsDO.uip} + uip;""")
